...
try {
  ...
  run(
    ...
    [
      ...
      persistTo,
      "--command",
      `UPDATE workspaces SET deleted_at = ${Date.now()} WHERE id = '${workspaceId}'`,
    ],
  ...
  run(
    ...
    "Deleted workspace protocol client",
  );
  run(
    pnpm,
    [
      ...
      persistTo,
      "--command",
      `UPDATE workspaces SET deleted_at = NULL WHERE id = '${workspaceId}'`,
    ],
